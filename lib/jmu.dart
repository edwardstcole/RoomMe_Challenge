...
class JMUScreen extends StatefulWidget{
  @override
  State<JMUScreen> createState() => _JMUScreenState();
}

class _JMUScreenState extends State<JMUScreen> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('James Madison University Students'),
      ),
      body: Container(
